...
const List<WindowDesign> kWindowDesigns = [
  ...
  WindowDesign(id: 'cmt_3', family: 'Casement', label: 'CMT 3', cols: 2, rows: 2, rowFractions: [0.25, 0.75]),
  WindowDesign(id: 'cmt_4', family: 'Casement', label: 'CMT 4', cols: 1, rows: 2),
  WindowDesign(id: 'cmt_5', family: 'Casement', label: 'CMT 5', cols: 1, rows: 1),
  WindowDesign(id: 'cmt_6', family: 'Casement', label: 'CMT 6', cols: 1, rows: 1),
  WindowDesign(id: 'cmt_7', family: 'Casement', label: 'CMT 7', cols: 1, rows: 1),
  WindowDesign(id: 'cmt_8', family: 'Casement', label: 'CMT 8', cols: 2, rows: 1),
  WindowDesign(id: 'cmt_9', family: 'Casement', label: 'CMT 9', cols: 2, rows: 2, rowFractions: [0.75, 0.25]),
  WindowDesign(id: 'cmt_10', family: 'Casement', label: 'CMT 10', cols: 2, rows: 2, rowFractions: [0.7, 0.3]),
  WindowDesign(id: 'cmt_11', family: 'Casement', label: 'CMT 11', cols: 2, rows: 2, rowFractions: [0.3, 0.7]),
  WindowDesign(id: 'cmt_12', family: 'Casement', label: 'CMT 12', cols: 2, rows: 2, rowFractions: [0.3, 0.7]),
  WindowDesign(id: 'cmt_13', family: 'Casement', label: 'CMT 13', cols: 2, rows: 1),
  WindowDesign(id: 'cmt_14', family: 'Casement', label: 'CMT 14', cols: 2, rows: 2, rowFractions: [0.78, 0.22]),
  WindowDesign(id: 'cmt_15', family: 'Casement', label: 'CMT 15', cols: 2, rows: 1),
  WindowDesign(id: 'cmt_16', family: 'Casement', label: 'CMT 16', cols: 2, rows: 1),
  WindowDesign(id: 'cmt_17', family: 'Casement', label: 'CMT 17', cols: 1, rows: 1),
  WindowDesign(id: 'cmt_18', family: 'Casement', label: 'CMT 18', cols: 1, rows: 2, rowFractions: [0.3, 0.7]),
  WindowDesign(id: 'cmt_19', family: 'Casement', label: 'CMT 19', cols: 1, rows: 2, rowFractions: [0.3, 0.7]),
